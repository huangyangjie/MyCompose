...
public class AdmisPermitDetailInfoEntity {
    ...
    public String toString() {
        return "AdmisPermitDetailInfoEntity{" +
                "code=" + code +
                ", message='" + message + '\'' +
                ", data=" + data +
                '}';
    ...
    public static class DataBean {
        ...
        private String patient_addr_home;
        ...
        public String toString() {
            return "DataBean{" +
                    ...
                    ", patient_addr_home='" + patient_addr_home + '\'' +
        ...
        public String getPatient_addr_home() {
            return patient_addr_home;
        }

        public void setPatient_addr_home(String patient_addr_home) {
            this.patient_addr_home = patient_addr_home;
        }
